...
VulkanApp::VulkanApp() : window(nullptr), instance(VK_NULL_HANDLE), debugMessenger(VK_NULL_HANDLE),
    surface(VK_NULL_HANDLE), device(VK_NULL_HANDLE), graphicsQueue(VK_NULL_HANDLE), presentQueue(VK_NULL_HANDLE) {
}
...
void VulkanApp::drawFrame() {
    ...
    ImGui::Text("Hello, ImGui with Fira Code!");
